...
object TPCH extends TPCBenchmark {

  override val schemaName: String = "tpch"
  ...
  override val tablesDefs: Map[String, Array[StructField]] = Map(
    "lineitem" -> Array(
      ...
      StructField("l_linenumber", LongType, nullable = false),
      StructField("l_quantity", IntegerType, nullable = false),
    ...
    "orders" -> Array(
      ...
      StructField("o_shippriority", StringType, nullable = false),
    ...
    "part" -> Array(
      ...
      StructField("p_size", ByteType, nullable = false),
    ...
    "customer" -> Array(
      ...
      StructField("c_nationkey", ByteType, nullable = false),
    ...
    "supplier" -> Array(
      ...
      StructField("s_nationkey", ByteType, nullable = false),
    ...
    "nation" -> Array(
      StructField("n_nationkey", ByteType, nullable = false),
      StructField("n_name", StringType, nullable = false),
      StructField("n_regionkey", ByteType, nullable = false),
      StructField("n_comment", StringType, nullable = false)
    ),

    "region" -> Array(
      StructField("r_regionkey", ByteType, nullable = false),
  ...
  private def addViews() {
    Spark.sql(
      """
        ...
        |		l_suppkey
        |""".stripMargin
    ).createOrReplaceTempView("revenue_view_15")
  }
